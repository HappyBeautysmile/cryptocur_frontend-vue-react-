            ...
            <Slider className="overflow-hidden" {...widgetsCarousels2A}>
                ...
                //  onClick={handleCoin({item:item,event:"chooseCoinUse"})}
                  <Grid item key = {i} md ={12}> 
                    <Card  style={{height:"225px", margin:"0 10px"}} className={item.use === true ? "card-box card-box-hover-rise p-4 card-box-border-bottom bg-first text-white border-primary mb-5" : "card-box card-box-hover-rise p-4 card-box-border-bottom border-warning mb-5"} >
                      {item.newMessage > 0 && 
