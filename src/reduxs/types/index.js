...
export const GET_USERLIST = "THEME_OPTIONS/GET_USERLIST";

// fiat
export const GET_ALLFIAtSLIST = "THEME_OPTIONS/GET_ALLFIAtSLIST";
export const GET_SELECTEDFIAT = "THEME_OPTIONS/GET_SELECTEDFIAT";
export const GET_OWNERFIAtSLIST = "THEME_OPTIONS/GET_OWNERFIAtSLIST";
// currencies
export const GET_CURRENCYLIST = "THEME_OPTIONS/GET_CURRENCYLIST";
...
// settings
export const GET_BANKACCOUNT = "THEME_OPTIONS/GET_BANKACCOUNT";
// wallets
export const GET_WALLETLIST = "THEME_OPTIONS/GET_WALLETLIST";

// coins
export const GET_ALLCOINSLIST = "THEME_OPTIONS/GET_ALLCOINSLIST";
